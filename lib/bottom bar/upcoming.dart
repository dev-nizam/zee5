    ...
    return Scaffold(
      ...
      body:ListView(
        children: [
          ...
          UpPage(ReleasingDate: 'releasing on date', Image: "asset/image/HomeImage/maxresdefault.jpg", Details:                 "Story: Slow-witted but an eternal optimist, Laal Singh Chaddha (Aamir Khan) stumbles through life, thinking to himself — should you write your own destiny or float freely like a feather going  of both? Directed by Advait Chandan, the film is a Hindi adaptation of Robert Zemeckis’ 1994 ",
            type: 'Durang|Trailer', model: 'Romance.Thriller.Suspense.Crime.U/A13+.Hindi',),
        ],
      ),
